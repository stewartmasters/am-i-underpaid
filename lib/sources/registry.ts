...
export const SOURCE_REGISTRY: DataSource[] = [
  ...
  },
  {
    ...
    implementation_notes: "France earnings data from Eurostat SES 2022/2024 cross-referenced with INSEE DADS figures. Raw data stored in data/raw/insee/. Records currently contributed via eurostat-ses source pathway — Eurostat SES incorporates INSEE DADS as a primary national input for France. Paris city-level derived from Île-de-France Eurostat regional data.",
    last_ingested: "2026-03-28",
    data_version: "SES-2022-FR-updated-2024",
  },
  {
    id: "cbs-nl",
    name: "CBS Netherlands — Arbeidsrekeningen (Labour Accounts)",
    short_name: "CBS",
    category: "official_stats",
    countries_supported: ["NL"],
    role_families: ["*"],
    ingestion_mode: "import",
    freshness_expectation_months: 12,
    confidence_weight: 0.85,
    enabled: true,
    url: "https://www.cbs.nl/en-gb/figures/detail/80072ned",
    legal_notes: "CBS Netherlands data published under CC BY 4.0. Free to use with attribution.",
    implementation_notes: "Netherlands earnings data from CBS Labour Accounts 2022 cross-referenced with Eurostat SES 2022. Raw data stored in data/raw/cbs/. Records currently contributed via eurostat-ses source pathway — CBS data used to validate and update Eurostat SES Netherlands figures. Amsterdam city-level derived from CBS regional data showing ~7–10% premium over national median.",
    last_ingested: "2026-03-28",
    data_version: "CBS-2022-NL-updated-2024",
  },
  {
    id: "levels-fyi",
