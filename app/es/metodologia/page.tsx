  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li><strong>INE Encuesta de Estructura Salarial 2022</strong> (ine-ees) — Encuesta nacional de estructura salarial de España. Códigos de ocupación CNO-11. Incluye desglose regional de la Comunidad de Madrid y Cataluña (usado para Madrid y Barcelona). Se requiere atribución al INE. <em>Solo España.</em></li>
          <li><strong>Eurostat Structure of Earnings Survey 2022</strong> (eurostat-ses) — Datos de ingresos por estados miembros de la UE por ocupación ISCO-08, tamaño de empresa y país. Cubre DE, NL, ES, FR, IE y otros. Se actualiza cada 4 años. <em>Mercados europeos continentales.</em></li>
          <li><strong>Destatis Verdienststrukturerhebung 2022</strong> (destatis-vse) — Encuesta de estructura salarial nacional de Alemania. Códigos de ocupación KldB 2010. Incluye desglose del estado federal de Berlín. <em>Solo Alemania.</em></li>
          <li><strong>UK ONS ASHE 2024</strong> (ons-uk) — Annual Survey of Hours and Earnings. Códigos de ocupación SOC 2020. Cubre el pago bruto anual nacional del Reino Unido y regional de Londres. <em>Solo ubicaciones del Reino Unido.</em></li>
