...
import { getBlogPostBySlugES, getAllBlogSlugES } from "@/data/blog-posts-es";
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const title = post?.title ?? "Blog de SalaryVerdict";
  const description = post?.description ?? "Consejos sobre salarios y finanzas laborales.";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1, justifyContent: "center", paddingTop: "32px", paddingBottom: "32px" }}>
          ...
          <div
            style={{
              color: "#ffffff",
              fontSize: title.length > 50 ? "46px" : title.length > 35 ? "56px" : "66px",
              fontWeight: 800,
              lineHeight: 1.1,
